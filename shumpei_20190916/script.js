...
//      pg2.stroke(255);
      pg2.strokeWeight(5);
      pg2.noFill();
      pg2.rect(i,100,20,100);
      pg2.rect(i,200,20,100);
      pg2.rect(i,300,20,100);
      pg2.rect(i,400,20,100);
      pg2.rect(i,500,20,100);
    
//      pg2.fill(10);
//      pg2.stroke(100);
//      pg2.rect(i,50,20,100);
      pg2.rect(i,150,100,100);
      pg2.rect(i,250,100,100);
      pg2.rect(i,350,100,100);
      pg2.rect(i,450,100,100);
//          pg2.fill(0);
//      pg2.ellipse(mouseX, mouseY,random(200));
//      pg2.line(i,100,100,100);
...
function draw() {
  ...
  pg.background(0);
  pg.fill(255);
  pg.ellipse(mouseX, mouseY,random(400,450));
