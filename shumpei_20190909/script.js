...
class AnimationJ {
  ...
  rotate(frameCount);
  translate(frameCount*3, frameCount*3);
  ellipse(10, 10, 100+frameCount/20,100+frameCount/20);
//  rect(10, 10, random(1,30),random(1,30));
//  rect(20, 20, random(1,30),random(1,30));
//  rect(30, 30, random(1,30),random(1,30));
  pop();
}
}